...
//                if(fulltime){
//                    arremps.add(new FTEmp(i, vhr.roundtodecnum(2), vwage.roundtodecnum(2), vunion.roundtodecnum(2)));
//                }
//                else{
//                    arremps.add(new PTEmp(i, vhr.roundtodecnum(2), vwage.roundtodecnum(2), r.nextInt(4)+1));
//                }
//            }
