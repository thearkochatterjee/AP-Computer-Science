...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale(){
      ...
      for(Pixel[] rowArray: pixels){
          for(Pixel pixelObj: rowArray){
              avg = pixelObj.getBlue()+pixelObj.getGreen()+pixelObj.getRed();
              avg = avg/3;
  ...
  public void mirrorarms(){
      ...
      for (int row = 0; row < pixels.length; row++)
      {
          for (int col = 0; col < width / 2; col++)
          {
              ...
              if(lessthan100(leftPixel)){
                  rightPixel.setColor(leftPixel.getColor());
              }
              if(lessthan100(rightPixel)){
  ...
  private boolean lessthan100(Pixel test){
      int avg = test.getBlue()+test.getGreen()+test.getRed();
      avg = avg / 3;
      return (avg<100);
      // && test.getRed()<100 && test.getGreen()<100
  }
  ...
  public void mirrohorizontalbotottop(){
      Pixel[][] pixels = this.getPixels2D();
      Pixel leftPixel = null;
      Pixel rightPixel = null;
      int hight = pixels.length;
  ...
  public void mirrorTemple()
  {
    ...
    System.out.println("Number of iterations through loop " + count);
  }
  ...
  public void edgedetection2(int edgeDist){
      ...
      for (int row = 0; row < pixels.length-1; row++)
      {
               ...
               col < pixels[0].length-1; col++)
          {
              ...
              if(leftPixel.colorDistance(belowcolor)> edgeDist){
                  leftPixel.setColor(Color.black);
              }
              else{
                  leftPixel.setColor(Color.white);
...
//                  leftPixel.setColor(Color.WHITE);
  ...
  public static void main(String[] args) 
  {
    ...
    Picture sample1 = new Picture("src/IMG_2888.jpg");
    sample1.explore();
    beach.explore();
//    beach.zeroBlue();
//    beach.explore();
